...
const GOOGLE_API_KEY = "AIzaSyCQeAe3UeV--WsvoPK-8DbKBPgTuSAYiVg";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="${window.PROFILE_IMAGE_URL}" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar"  src="${window.VIVA_ICON_URL}" alt="Gemini avatar">
